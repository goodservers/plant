...
const plant = path.join(__dirname, 'plant')
const targetWin32 = path.join(__dirname, 'plant.exe')
const target = platform === 'win32' ? targetWin32 : plant
...
async function download() {
  ...
  info('For the source code, check out: https://github.com/goodservers/plant/')
