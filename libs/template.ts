...
export const _getTemplateVariables = (checkedToken: string) => (
  template: string
) => {
...
export const getFilesFromDirectory = async (directory: string) =>
  globby(
    [`${directory}/**/.*`, `${directory}/**/*`, `${directory}/.deploy/**/*`],
    {
...
export const writeTemplateVariables = async (directory: string, variables) => {
...
export const renderTemplate = (template: string, variables): string =>
